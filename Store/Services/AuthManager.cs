...
namespace Services
{
    public class AuthManager : IAuthService
    {
        ...
        public async Task<IdentityResult> ResetPassword(ResetPasswordDto resetpDto)
        {
            var user = await GetOneUser(resetpDto.UserName);

            await _userManager.RemovePasswordAsync(user);
            var result = await _userManager.AddPasswordAsync(user, resetpDto.Password);
            return result;
        }
