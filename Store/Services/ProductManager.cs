...
namespace Services
{
    public class ProductManager : IProductService
    {
        ...
        public IEnumerable<Product> GetAllProductsWithDetails(ProductRequestParameters productRequest)
        {
            return _manager.Product.GetAllProductsWithDetails(productRequest);
        }
